...
plugins=(cp git docker pip python sudo z systemd autoswitch_virtualenv zsh-syntax-highlighting zsh-completions zsh-autosuggestions kubectl aws minikube)
